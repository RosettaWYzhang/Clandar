...
var CalendarPage = (function () {
    function CalendarPage(navCtrl, modalCtrl, alertCtrl, ionicCalendar) {
        this.navCtrl = navCtrl;
        this.modalCtrl = modalCtrl;
        this.alertCtrl = alertCtrl;
        ...
        this.ionicCalendar.createCalendar('MyCalendar').then(function (msg) { console.log(msg); }, function (err) { console.log(err); });
    }
    //   constructor(public navCtrl: NavController, public navParams: NavParams) {
    //   }
    CalendarPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad Calendar');
        console.log(this.ionicCalendar.hasReadPermission());
        console.log(this.ionicCalendar.hasReadWritePermission());
        console.log(this.ionicCalendar.hasWritePermission());
        console.log(this.ionicCalendar.findEvent());
    };
    //    calendar = {
    //        mode: 'month',
    //        currentDate: new Date()
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__pipes_friend__ = __webpack_require__(1165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__pipes_search__ = __webpack_require__(1166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__pipes_conversation__ = __webpack_require__(1167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__pipes_date__ = __webpack_require__(1168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__pipes_group__ = __webpack_require__(1169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__providers_loading_loading__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__providers_auth_service_logout__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47_firebase__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__providers_data_data__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__providers_image_image__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__providers_firebase_firebase__ = __webpack_require__(201);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
